        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="admin.php?page=deletekelas&id_kelas=<?= $d['id_kelas'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan menghapus data ini')">Hapus</a>
                </td>
            </tr>
